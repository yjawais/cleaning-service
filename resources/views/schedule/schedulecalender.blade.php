...
<div class="main-content" id="panel">
  ...
  <!-- Argon Scripts -->
  <!-- Core -->
  <script src="adminPanel/vendor/jquery/dist/jquery.min.js"></script>
  <script src="adminPanel/vendor/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
  <script src="adminPanel/vendor/js-cookie/js.cookie.js"></script>
  <script src="adminPanel/vendor/jquery.scrollbar/jquery.scrollbar.min.js"></script>
  <script src="adminPanel/vendor/jquery-scroll-lock/dist/jquery-scrollLock.min.js"></script>
  <!-- Optional JS -->
  <script src="adminPanel/vendor/moment/min/moment.min.js"></script>
  <script src="adminPanel/vendor/fullcalendar/dist/fullcalendar.min.js"></script>
  <script src="adminPanel/vendor/sweetalert2/dist/sweetalert2.min.js"></script>
  <!-- Argon JS -->
  <script src="adminPanel/js/argon.js?v=1.2.0"></script>
