          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select class="form-control" for="slider_for" id="slider_for" name="slider_for" readonly>
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control" rows="5" readonly>{{$slider['description']}}</textarea>
              </div>
            </div>
          </div>
          <div class="row">
