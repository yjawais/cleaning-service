               ...
               @foreach($social_settings as $social_setting)
                  <tr>
                   ...
                   <td style="color:green">Activate</td>
                    ...
                    @endif
                    <td> 
                   <a href="{{route('social.show',$social_setting->slug)}}"><button type="button" class="btn btn-success btn-icon-only rounded-circle" >

<i class="ni ni-album-2"></i>
</button> </a>
<a href="{{route('social.edit',$social_setting->slug)}}">
...
<a href="{{route('social.destroy',$social_setting->slug)}}"><button type="button" class="btn btn-danger btn-icon-only rounded-circle">
