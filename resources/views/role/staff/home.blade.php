...
@section('sidebar')
  @include('include.dashboard.role.staff.sidebar')
@endsection
                ...
                <div class="col-xl-4 col-md-6">
                  <div class="card bg-gradient-primary border-0">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
                          <h5 class="card-title text-uppercase text-muted mb-0 text-white">Order Pending</h5>
                ...
                <div class="col-xl-4 col-md-6">
                  <div class="card bg-gradient-info border-0">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
                          <h5 class="card-title text-uppercase text-muted mb-0 text-white">Take Away</h5>
                ...
                <div class="col-xl-4 col-md-6">
                  <div class="card bg-gradient-danger border-0">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
                          <h5 class="card-title text-uppercase text-muted mb-0 text-white">Online Payment</h5>
